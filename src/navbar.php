              ...
              <div class="col-md-12">
                  <nav class="navbar navbar-expand-lg navbar-light fixed-top bg-white m-0 mt-0 mb-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                      <ul class="navbar-nav">
                        <li class="nav-item">
                          <a class="nav-link" href="index.html" style="color:#101D6B">Home<span class="sr-only">(current)</span></a>
                        </li>
                        <li class="nav-item dropdown">
                          ...
                          <div class="dropdown-menu" aria-labelledby="complaintsDropdown">
                            ...
                            <a class="dropdown-item" href="view-people.html" style="color:#101D6B"><b>View People and Cases</b></a>
                            <a class="dropdown-item" href="complaint-study.html" style="color:#101D6B"><b>Complaint Study</b></a>
                          </div>
                        </li>
                        <li class="nav-item dropdown">
                          ...
                          <div class="dropdown-menu" aria-labelledby="dutiesDropdown">
                            <a class="dropdown-item" href="general_Duty_Update.html" style="color:#101D6B"><b>General Duty</b></a>
                            <a class="dropdown-item" href="special-duty.html" style="color:#101D6B"><b>Special Duty</b></a>
                            <a class="dropdown-item" href="emergency-duties.html" style="color:#101D6B"><b>Emergency Duty</b></a>
                          </div>
                        </li>
                        <li class="nav-item dropdown">
                          ...
                          <div class="dropdown-menu" aria-labelledby="leavesDropdown">
                            <a class="dropdown-item" href="submit-leave-medical.html" style="color:#101D6B"><b>Submit Leaves</b></a>
                          </div>
                        </li>
                        <li class="nav-item dropdown">
                          ...
                          <div class="dropdown-menu" aria-labelledby="employeeDropdown">
                            <a class="dropdown-item" href="New_Employee.html" style="color:#101D6B"><b>Add New Employee</b></a>
                            <a class="dropdown-item" href="check-avalability.html" style="color:#101D6B"><b>Check Employee Avalability</b></a>
                          </div>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link" href="payroll.html" style="color:#101D6B">Salary</a>
                        </li>
                        <li class="nav-item">
