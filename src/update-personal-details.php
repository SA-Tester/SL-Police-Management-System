...
$sql = "SELECT * FROM employee e,login l WHERE l.username='$username' AND l.empID=e.emplD"; // Corrected column name
$stmt = $con->prepare($sql);
$stmt->execute();
$oldDetails = $stmt->fetch(PDO::FETCH_ASSOC);
$_SESSION['empID']=$oldDetails['emplD'];
                                    ...
                                    <div class="row">
                                        <div class="col">
                                                <div class="mb-3"><label class="form-label"><strong>Employee
                                                            ID</strong></label></div><input class="form-control" type="text" id="emplD" name="emplD" required value="<?php echo $oldDetails['emplD']; ?>" disabled >
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="mb-3"><label class="form-label"><strong>Marital
                                                        Status</strong></label></div><input class="form-control" type="text" id="marital_status" name="marital_status" required value="<?php echo $oldDetails['marital_status']; ?>">
                                        </div>
