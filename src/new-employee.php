                                ...
                                <form action="New_EmployeeForm.php" method="POST">
                                            ...
                                            <div class="col">
                                                <div class="mb-3"><label class="form-label" ><strong>Employee
                                                            ID</strong></label></div><input class="form-control"
                                                                                type="text" id="emplD" name="emplD" required>
                                            </div>
                                            <div class="col">
                                                <div class="mb-3"><label class="form-label"
                                                                         ><strong>NIC</strong></label></div><input
                                                    class="form-control" type="text" id="nic" name="nic" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col">
                                                <div class="mb-3"><label class="form-label"
                                                                         ><strong>DOB</strong></label></div><input
                                                    class="form-control" type="date" id="dob" name="dob" required>
                                            </div>
                                            <div class="col">
                                                <div class="mb-3"><label class="form-label"
                                                                         ><strong>Gender</strong></label></div><select
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col">
                                                <div class="mb-3"><label class="form-label"
                                                                         ><strong>Contact</strong></label></div><input
                                                    class="form-control" type="tel" id="tel_no" name="tel_no" required>
                                            </div>
                                            <div class="col">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col">
                                                <div class="mb-3"><label class="form-label"
                                                                         ><strong>Address</strong></label></div><input
                                                    class="form-control" type="text" id="address" name="address" required>
                                            </div>
                                        </div>
                                        <br>
                                        <div class="row">
                                            <div class="col">
                                                <div class="mb-3"><label class="form-label" ><strong>Marital
                                                            Status</strong></label></div><input class="form-control"
                                                                                    type="text" id="marital_status" name="marital_status" required>
                                            </div>
                                            <div class="col">
                                                <div class="mb-3"><label class="form-label"
                                                                         ><strong>Rank</strong></label></div><input
                                                    class="form-control" type="text" id="rank" name="rank" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                            ...
                                            <div class="col">
                                                <div class="mb-3"><label class="form-label" ><strong>Joined
                                                            Date</strong></label></div><input class="form-control"
                                                                                  type="date" id="appointment_date" name="appointment_date" required>
                                            </div>
                                            <div class="col">
                                                <div class="mb-3"><label class="form-label"
                                                                         ><strong>Retired Status</strong></label></div>
