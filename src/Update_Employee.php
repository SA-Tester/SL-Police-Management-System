...
if (isset(  $_POST['first_name'], $_POST['last_name'], $_POST['dob'], $_POST['tel_no'], $_POST['email'], $_POST['address'], $_POST['marital_status'])) {
    ...
    $sql = "UPDATE employee SET  first_name = :first_name, last_name = :last_name, dob = :dob,  tel_no = :tel_no, email = :email, address = :address, marital_status = :marital_status WHERE emplD = :emplD";
    ...
    $stmt->bindParam(':emplD', $employeeId);
