...
$message = null;
$reset_empID = $_SESSION['reset_empID'];
    ...
    if (isset($_POST["new_password"], $_POST["confirm_password"])) {
        ...
        if (empty($_POST["new_password"]) || empty($_POST["confirm_password"])) {
            ...
            if ($new_password === $confirm_password) {
                ...
                try {
                    $update_query = "UPDATE login SET password = ? WHERE empID = ?";
                    $pstmt = $con->prepare($update_query);
                    $pstmt->bindValue(1, $hashed_newPassword);
                    $pstmt->bindValue(2, $reset_empID);
                    if ($pstmt->execute()) {
                    ...
                    die("Error in executing update query: " . $e->getMessage());
                }
    ...
    <div class="container-fluid">
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
            ...
            <div class="form-group mb-3 mt-5">
                ...
                <input type="password" name="new_password" class="form-control" id="new_password" aria-describedby="emailHelp">
