                ...
                <div class="containerx">
                    ...
                    <form action="leaveManagement-process.php" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-75">
                                <input type="text" id="from_date" name="from_date" value="<?php echo $employee->leave_start?>" readonly/>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-25">
                            ...
                            <div class="col-75">
                                <input type="text" id="to_date" name="to_date" value="<?php echo $employee->leave_end?>" readonly/>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-25">
                            ...
                            <div class="col-75">
                                <input type="text" id="reason_type" name="reason_type" value="<?php echo $employee->reason_type?>" readonly/>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-25">
                            ...
                            <div class="col-75">
                                <input type="text" id="reason_desc" name="reason_desc" style="height:auto;" value="<?php echo $employee->reason?>" readonly></textarea>
                            </div>
                        </div>
                        <div class="row">
                            <img src="../uploads/medicals/<?php echo $employee->medical?>" alt="Medical Not Found" width="100%" style="margin:20px 0;">
                        </div>
                        <div class="row">
                        ...
                        <table class="table-con">
                            ...
                            <?php
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $employee->leave_end?></td>
                                    <td><?php echo $duration?></td>
                                    <td><?php echo $employee->reason_type?></td>
                                </tr>
                                            <?php
                                            $i++;
                                        }
