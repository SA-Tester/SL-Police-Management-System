...
if (isset($_SESSION["user_id"], $_SESSION["role"], $_SESSION["username"]) && ($_SESSION["role"] == "admin" || $_SESSION["role"] == "accountant_officer")) {
    ...
    <body>
                        ...
                        try {
                            ...
                            foreach ($rs as $employee) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php echo $employee->service_years; ?>
                                    </td>
                                    <td>
                                        <?php echo $employee->bartar_amount; ?>
                                    </td>
                                    <td>
                                        <?php echo $employee->total_salary; ?>
                                    </td>
                                    <td>
                                        <?php echo $employee->pension_amount; ?>
                                    </td>
                                    <td class="buttons"><a class="btn2"
                                            href="retired-employee.php?empID=<?php echo $employee->empID; ?>&base_salary=<?php echo $employee->base_salary; ?>">Retired</a>
                                        <a class="btn2"
                                            href="reset-payroll.php?empID=<?php echo $employee->empID; ?>&base_salary=<?php echo $employee->base_salary; ?>">Reset</a>
                                        <!-- <a class="btn2" href="remove-payroll.php?empID=<?php echo $employee->empID; ?>">Remove</a>  -->
                                        <button type="button" class="btn2" data-id="<?php echo $employee->empID; ?>"
                                            onclick="confirmDelete(this);">Remove</button>
                                        <button type="button" class="btn2" data-id="<?php echo $employee->empID; ?>"
                                            onclick="sendSalarySheet(this);">Send</button>
        ...
        <form action="process-payroll.php" method="POST" class="msg_container" id="msg_container">
            ...
            <div class="form-group">
                <textarea style="height: 220px;" name="message" class="form-control" placeholder="Your Message" rows="5"
                    required></textarea>
            </div>
            <div class="buttons">
