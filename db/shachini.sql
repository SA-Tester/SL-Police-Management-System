...
(41, '2023-09-05', 'Criminal Offence', 'Attempted crime in a house robbery', NULL, 'An attempt to commit a child harassment during a house robbery was reported in Dambana, Badulla.', 'Ongoing', 'EMP0004', 41);
...
(5, 'EMP0001', '2023-09-08', '2023-09-11', 'Personal', 'To attend my child&#39;s new school admission procedures', 'Algorithms Roadmap.png');
...
('EMP0001', 'U0001', '$2y$10$R/CFWJmz6EzGLmNoqbMTVOu9TRiQIyTOekggnSFpWFA.DT2RYsRVi', 'user'),
...
('EMP0004', 'gimhani', '$2y$10$gWd70I49j/STaZHqcTCydewxORLXuCQIzA9ANGab0ACi4Oek6PIN.', 'user'),
...
--
ALTER TABLE `role_in_case`
  MODIFY `row_no` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
